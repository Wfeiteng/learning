...
public class LowestCommonAncestorOfABinarySearchTree235 {
    public static void main(String[] args) {
        ...
        TreeNode root = TreeNodeUtil.generate(new Integer[]{6, 2, 8, 0, 4, 7, 9, null, null, 3, 5});
        TreeNode famliy = solution.lowestCommonAncestor(root, new TreeNode(2), new TreeNode(8));
